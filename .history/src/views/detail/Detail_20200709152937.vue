          ...
          <div class="stuff_2">
            ...
            <div class="stuff_e" @edit-num="editNum">
              <div class="item-cols-num clearfix">
                <div class="select">
                  <div class="down" @click.stop.prevent="down()" :class="{'down-disabled':Num<=1}">
                    <Icon type="ios-remove-circle-outline" color='red'/>
                  </div>
                  <span class="num">
                    <div><input
                      type="text"
                  ...
                  <div class="up" :class="{'up-disabled':Num>=limit}" @click.stop.prevent="up()">
                    <Icon type="ios-add-circle-outline" color='red'/>
                  </div>
                </div>
              </div>
            </div>
